...
public class Granjero extends Personaje {
	...
	public static Granjero personajeGranjero() {
		...
		Granjero granjero = new Granjero("Granjero",100,100,new String[] { "golde de Azada", "Semillazos", "dar rabano" },
	            new int[] { 30, 20, -20 });
	...
	public static void iniciarAventuraGranjero() {
		...
		System.out.println(
				"Como granjero deberas cultivar y ganar todo el dinero que puedas para conseguir la meta de dinero en menos de dos dias, o en su defecto completar el centro civico con las colecciones o mudarte a la ciudad con el billete, solo asi podras ganar el juego");
		System.out.println(
				"si mueres, pierdes. Como estas en primavera los cultivos que creecen en esta epoca es el trigo, deberias comprar el trigo para plantarlo, ve a la tienda y dile a la tendera que quieres...");
		...
		Batalla.iniciarBatalla(granjeroPer, enemigoPer);
	...
	public void primeraMisionGranjero() {
		...
		System.out.println(
				"ahora es hora de plantar, sin embargo hay un problema, tu vecino te cogio la azada prestada, deberas ir a convencerle de que te la devuelva");
				System.out
				.println("*te dirijes a casa de tu vecino tocandole la puerta y este abria la puerta al rato*");
	...
	public void misionCultivar() {
		...
		System.out.println(
				"ahora que vuelves a tener azada puedes empezar a cultivar, aqui tienes las instrucciones:");
				...
				System.out.println(
				"Es importante aclarar que cualquier opcion que no sea en este orden estropearan el cultivo");
	...
	public void misionMadre() {
		...
		System.out.println(
				"-Hola hijo, ¿Que tal tu vida por el Campo?, espero que muy bien, como siempre con mis cartas viene la paga de tu abuela, sin embargo esta vez prefiero complicarte las cosas un poco, solo te mandare el dinero en el caso de que aciertes este acertijo... ");
		System.out.println(
	...
	public void ovejitas() {
		...
		System.out.println(
				...
				if (opcion == 2) {
				System.out.println(
				" y ∫ " + "(1+ln(x)/" + "xsin(x))" + " dx ¿Cuantas ovejitas son?");
	...
	public void misionZanahorias() {
		...
		System.out.println("*Pasa el dia y vas a la tienda a comprar, como ya esta empezando verano comprar zanahorias es lo que mas dinero te daria");
		Economia.getInstance().Tienda();
		System.out.println("*al volver a tu campo a plantar te encuentras con unos pajaros que estan estropeando tus cultivos, decides armarte e ir a combatirlos*");
	}
	...
	public void misionTractor() {
		...
		System.out.println(
				"*tras la ardua pelea decides tomarte un descanso de la plantacion, pues tu campo habia sido arrollado por la epica pelea entre el mamifero y el oviparo, por lo que sigues trabajando en tus otros planes como seria modificar tu tractor*");
