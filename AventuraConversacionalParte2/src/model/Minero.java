...
public class Minero extends Personaje {
	...
	public static void iniciarAventuraMinero() {
		...
		mineroProt.imprimirPersonaje();
         ...
         System.out.println("Como minero deberás excavar y recolectar recursos valiosos. Para ganar deberás obtener piedra luminosa, \nllegar al final del nivel 2 de la mina o salir con una pepita de oro.");
         mineroProt.inicioPelea();
         Batalla.iniciarBatalla(mineroProt, rata,3);
